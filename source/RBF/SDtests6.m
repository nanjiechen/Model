...
methods.RecModel = @RecMapRBF;
% methods.Spatial2ind = @spatial2ind;
 methods.Spatial2ind = @SortEnergiesRBF;
...
parameters.GRFModel.KLRescale = 1;
...
[parameters] = methods.RBFinit(parameters);
...
[parameters,results] = methods.CollectEng(parameters,results,methods);
